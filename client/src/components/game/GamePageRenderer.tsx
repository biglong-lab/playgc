...
const TimeTravelPage = lazy(() => import("@/components/game/multi/TimeTravelPage"));
const MuseumCardPage = lazy(() => import("@/components/game/multi/MuseumCardPage"));
const NightSkyPage = lazy(() => import("@/components/game/multi/NightSkyPage"));
...
const PortalDoorPage = lazy(() => import("@/components/game/multi/PortalDoorPage"));
const LampLightPage = lazy(() => import("@/components/game/multi/LampLightPage"));
const OceanWavePage = lazy(() => import("@/components/game/multi/OceanWavePage"));
const FireworkBurstPage = lazy(() => import("@/components/game/multi/FireworkBurstPage"));
const SeedGardenPage = lazy(() => import("@/components/game/multi/SeedGardenPage"));
const CloudDriftPage = lazy(() => import("@/components/game/multi/CloudDriftPage"));
const CrystalBallPage = lazy(() => import("@/components/game/multi/CrystalBallPage"));
const MapPinPage = lazy(() => import("@/components/game/multi/MapPinPage"));
const TreasureChestPage = lazy(() => import("@/components/game/multi/TreasureChestPage"));
const RocketLaunchPage = lazy(() => import("@/components/game/multi/RocketLaunchPage"));
const GlassBottlePage = lazy(() => import("@/components/game/multi/GlassBottlePage"));
...
const TidePoolPage = lazy(() => import("@/components/game/multi/TidePoolPage"));
...
const KoiPondPage = lazy(() => import("@/components/game/multi/KoiPondPage"));
const InkBrushPage = lazy(() => import("@/components/game/multi/InkBrushPage"));
const FireflyDancePage = lazy(() => import("@/components/game/multi/FireflyDancePage"));
const LotusBloomPage = lazy(() => import("@/components/game/multi/LotusBloomPage"));
const MapleDriftPage = lazy(() => import("@/components/game/multi/MapleDriftPage"));
const SpiralShellPage = lazy(() => import("@/components/game/multi/SpiralShellPage"));
const WisteriaVinePage = lazy(() => import("@/components/game/multi/WisteriaVinePage"));
const NightBloomPage = lazy(() => import("@/components/game/multi/NightBloomPage"));
...
export default function GamePageRenderer({
  ...
  const renderPage = () => {
    switch (page.pageType) {
      ...
      case "color_mood":
        return <ColorMoodPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "life_tree":
      ...
      case "time_travel":
        return <TimeTravelPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "museum_card":
        return <MuseumCardPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "night_sky":
        return <NightSkyPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "soup_ingredient":
        return <SoupIngredientPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "volcano_report":
      ...
      case "portal_door":
        return <PortalDoorPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "lamp_light":
        return <LampLightPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "ocean_wave":
        return <OceanWavePage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "firework_burst":
        return <FireworkBurstPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "seed_garden":
        return <SeedGardenPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "cloud_drift":
        return <CloudDriftPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "crystal_ball":
        return <CrystalBallPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "map_pin":
        return <MapPinPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "treasure_chest":
        return <TreasureChestPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "rocket_launch":
        return <RocketLaunchPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "glass_bottle":
        return <GlassBottlePage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "sand_timer":
        return <SandTimerPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "wishing_well":
      ...
      case "tide_pool":
        return <TidePoolPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "campfire_story":
        return <CampfireStoryPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "star_catcher":
      ...
      case "koi_pond":
        return <KoiPondPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "ink_brush":
        return <InkBrushPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "firefly_dance":
        return <FireflyDancePage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "lotus_bloom":
        return <LotusBloomPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "maple_drift":
        return <MapleDriftPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "spiral_shell":
        return <SpiralShellPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "wisteria_vine":
        return <WisteriaVinePage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "night_bloom":
        return <NightBloomPage {...commonProps} pageId={page.id} config={page.config as Record<string, unknown>} />;
      case "memory_match":
