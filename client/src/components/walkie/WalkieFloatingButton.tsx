...
export function WalkieFloatingButton({
  ...
  const [quickQrOpen, setQuickQrOpen] = useState(false);       // 🆕 QR 快捷浮窗
      ...
      <AnimatePresence>
        {expanded && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-[9999] w-72 bg-card border rounded-xl shadow-xl overflow-hidden"
          >
            {/* Header */}
