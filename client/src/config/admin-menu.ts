...
export const ADMIN_MENU_GROUPS: AdminMenuGroup[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { title: "活動管理", icon: Activity, path: "/admin/activities", permission: "booking:manage" },
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    items: [
      { title: "POS 工作站", icon: DollarSign, path: "/pos", permission: "pos:view" },
      { title: "QR 掃描", icon: QrCode, path: "/pos/scan", permission: "pos:operate" },
      { title: "今日預約", icon: Calendar, path: "/pos/bookings/today", permission: "pos:operate" },
      { title: "現場收款", icon: Receipt, path: "/pos/checkout", permission: "pos:operate" },
      { title: "券核銷", icon: Ticket, path: "/pos/voucher", permission: "pos:operate" },
      { title: "今日小結", icon: BarChart3, path: "/pos/summary", permission: "report:view" },
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { title: "預約調整", icon: Calendar, path: "/admin/troubleshoot/booking", permission: "booking:manage" },
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    items: [
      ...
      // 財務（需啟用 payment 模組）
      { title: "營收總覽", icon: DollarSign, path: "/admin/revenue", permission: "revenue:view", requiresModule: "payment" },
      { title: "商品管理", icon: Library, path: "/admin/revenue/products", permission: "revenue:view", requiresModule: "payment" },
      { title: "兌換碼中心", icon: Ticket, path: "/admin/revenue/codes", permission: "revenue:view", requiresModule: "payment" },
      { title: "交易記錄", icon: Activity, path: "/admin/revenue/transactions", permission: "revenue:view", requiresModule: "payment" },
