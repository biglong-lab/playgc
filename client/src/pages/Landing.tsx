...
// ═══════════ 公告 Banner（可關閉，sessionStorage 記住）═══════════
function AnnouncementBanner({ announcement }: { announcement: string | null }) {
  // 依公告內容 hash 產生 sessionStorage key — 公告變了 key 變，重新顯示
  ...
  return (
    ...
    >
      ...
      <span className="font-chinese text-center leading-relaxed flex-1 max-w-3xl">
        {announcement}
      </span>
      <button
        type="button"
