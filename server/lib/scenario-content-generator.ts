...
- "team_pact": { title, prompt, pactTitle }
  隊伍公約：每人選類別（溝通/尊重/協作/責任/成長/樂趣）並提出一條規則（≥5字），揭曉後以編號清單呈現集體公約，適合新團隊開場/企業文化建立/培訓開場/社群建立

- "energy_map": { title, prompt }
  能量地圖：每人選 4 象限（高能量高意願=充電滿格/高能量低意願=等待點火/低能量高意願=燃燒殆盡/低能量低意願=需要充電），揭曉後以 2×2 格子＋名單呈現，適合會議開場暖場/工作坊節奏感知/壓力管理/領導力培訓

- "challenge_map": { title, prompt, placeholder }
  挑戰地圖：每人選類別（技能缺口/資源不足/時間壓力/溝通困難/動力低落/方向不明）＋嚴重程度（高/中/低）＋描述，揭曉後以類別統計＋卡片牆呈現，適合工作坊問題收斂/專案後記/壓力感知/輔導工作坊

- "action_plan": { title, prompt }
  行動計畫：每人填行動（≥5字）＋截止時間（6選項）＋支援需求，揭曉後以編號清單呈現全隊行動承諾，適合培訓收尾/工作坊後行動承諾/專案啟動/年初目標設定

- "vision_board": { title, prompt }
  願景板：每人選時間跨度（5選項）＋最多3個關鍵詞（至少2個）＋一句話描述（≥5字），揭曉後以漸層卡片牆呈現全隊集體願景，適合年度規劃/新年願景/職涯探索/個人目標設定/新創啟動會

- "conflict_style": { title, prompt }
  衝突風格：5種TKI風格（競爭型/合作型/妥協型/迴避型/順應型）一鍵選擇，揭曉後以百分比長條圖＋成員清單呈現全隊衝突風格分布，適合團隊建立/管理培訓/人際溝通工作坊/組織文化盤點

- "peer_mirror": { title, prompt }
  同伴之鏡：每人挑選一位隊友＋從10個優點標籤中選一個＋選填具體行為描述，揭曉後以收件人分組呈現，讓每人看見他人眼中的自己，適合團隊建立/感謝文化/培訓結尾/新進人員融合

- "motivation_map": { title, prompt }
  動力地圖：6大核心動力（追求精進/人際連結/自主空間/使命感/被認可/穩定安全）一鍵選擇，揭曉後以百分比長條圖＋成員清單呈現全隊動力分布，適合管理培訓/個人發展工作坊/職涯探索/組織設計

- "hero_story": { title, prompt }
  英雄故事：每人填故事標題（≥2字）＋當時挑戰（≥5字）＋從中學到的（≥5字），揭曉後以彩色漸層卡片牆呈現全隊英雄故事集，適合培訓開場破冰/專案後記/年會/感謝典禮

- "learning_style": { title, prompt }
  學習風格：VARK四型（視覺/聽覺/閱讀/動覺）一鍵選擇，揭曉後以百分比長條圖＋成員清單呈現全隊學習偏好分布，適合教育訓練前置/學習型組織/師資培訓/課程設計工作坊

- "stress_signal": { title, prompt }
  壓力信號：1-5 等級選擇＋8個壓力來源類別＋選填說明，揭曉後以全隊平均值＋等級分布長條圖＋成員清單呈現，適合焦慮感知/團隊健康狀態檢查/壓力管理工作坊/輔導介入評估

- "decision_style": { title, prompt }
  決策風格：5種決策偏好（數據/直覺/共識/權威/實驗導向）一鍵選擇，揭曉後以百分比長條圖＋成員清單呈現全隊決策多樣性，適合管理培訓/組織設計/高效會議設計/領導力發展

- "three_words": { title, prompt }
  三個字：每人輸入三個詞語（各1字以上），揭曉後以彩色詞語牆呈現全隊集體詞彙，適合破冰/感受分享/創意開場/情緒簽到

- "team_radar": { title, prompt }
  團隊雷達：五個面向（成效/溝通/信任/活力/創新）各給1-5分，揭曉後顯示全隊平均雷達分數長條圖＋成員清單，適合團隊健康檢視/回顧會議/季度檢討/組織發展評估

- "today_feel": { title, prompt }
  今天感覺：每人輸入一個詞語＋選一個 emoji 描述當下感受，揭曉後以彩色詞語標籤牆呈現全隊集體情緒全景，適合開場暖身/情緒簽到/破冰/活動開幕

- "speed_fact": { title, prompt }
  閃速事實：每人選一個類別（隱藏才能/旅行故事/奇特口味/意外技能/有趣夢想/個人紀錄）並寫下一句驚人事實，揭曉後以彩色卡片牆逐一呈現，適合破冰/團隊認識/新人入職/互動暖場

- "color_vibe": { title, prompt }
  顏色心情：每人從8個顏色（各有情緒標籤）中選一個代表當下感受，揭曉後以大小不同的泡泡調色盤呈現全隊情緒分布，適合快速破冰/情緒確認/開場暖身/活動前置

- "good_news": { title, prompt }
  好消息分享：每人選一個類別（工作成就/個人成長/家庭生活/新技能/好事降臨/精彩體驗）並分享一則好消息，揭曉後以彩色漸層卡片牆呈現，適合團隊凝聚/正能量注入/員工關懷/聚會開場

- "love_advice": { title, prompt }
  愛的建議：每人從6個主題（溝通/冒險/尊重/歡笑/支持/驚喜）選一個類別並送出祝福建議，揭曉後以玫瑰系漸層卡片牆呈現，適合婚禮賓客互動/週年慶/送舊迎新/溫馨告別

- "fav_memory": { title, prompt }
  最愛回憶：每人選一個時間點（很久以前～最近）並分享一個難忘共同回憶，揭曉後以時間感卡片牆呈現，適合婚禮/生日/同學會/團隊告別/年末回顧

- "dream_trip": { title, prompt }
  夢想旅行：每人從6種旅遊類型（海島/山岳/城市/自然/文化/美食）選一個並輸入夢想目的地，揭曉後以彩色旅行卡片牆呈現，適合企業員工旅遊暖場/交誼聚會/旅遊前破冰/社群活動

- "book_rec": { title, prompt }
  好物推薦：每人從6種媒體類型（書籍/電影/Podcast/紀錄片/音樂/遊戲）選一個並填寫名稱與推薦理由，揭曉後以彩色推薦卡片牆呈現，適合知識分享/讀書會/文化交流/聚會暖場

- "motto_board": { title, prompt }
  人生座右銘：每人從6種人生態度（積極/感恩/學習/創意/堅韌/平衡）選一個並輸入座右銘（≥5字），揭曉後以彩色座右銘卡片牆呈現，適合企業內訓/新員工破冰/年度啟動/個人成長工作坊

- "time_capacity": { title, prompt }
  時間分配：每人分配一週168小時到6個生活領域（工作/家庭/健康/社交/學習/休息），揭曉後顯示全隊平均分配圖表與個人對比，適合工作生活平衡討論/員工關懷/職涯規劃工作坊

- "wish_list": { title, prompt }
  願望清單：每人從6個類別（事業/旅行/技能/健康/人際/創作）選一個並寫下願望，揭曉後以彩色願望卡片牆呈現，適合新年許願/生日派對/年末回顧/夢想激活工作坊

- "strength_map": { title, prompt }
  強項地圖：每人從8種強項（領導/創造/分析/同理/執行/連結/學習/溝通）選一個並分享一個真實故事，揭曉後以強項摘要標籤＋個人故事卡片呈現，適合團隊建立/新員工認識/能力盤點/職涯探索

- "secret_talent": { title, prompt }
  隱藏才能大揭密：每人輸入一個隱藏才能（≥3字）、選技術等級（入門/業餘/不錯/頗有水準/達人）並說故事（≥5字），揭曉後以彩色才能卡片牆呈現，適合破冰/交誼聚會/派對暖場/新員工認識

- "life_lesson": { title, prompt }
  人生一堂課：每人從6個領域（職場/人際/理財/健康/家庭/成長）和4個年齡段選擇，並分享一個寶貴功課（≥10字），揭曉後以彩色智慧卡片牆呈現，適合高齡活動/職涯工作坊/人生回顧/跨世代交流

- "animal_spirit": { title, prompt }
  精神動物：每人從12隻動物（獅子/貓頭鷹/海豚/老鷹/熊/狐狸/狼/烏龜/蝴蝶/貓熊/老虎/貓咪）選一隻並說原因（≥5字），揭曉後顯示動物徽章統計＋個人選擇卡片，適合破冰/自我介紹/活動開場/有趣暖場

- "childhood_game": { title, prompt }
  童年遊戲記憶：每人輸入遊戲名稱（≥2字）、選年代（80s/90s/00s/10s/近幾年）並分享一段回憶（≥5字），揭曉後以彩色遊戲卡片牆呈現，適合同學會/世代交流/懷舊主題/破冰活動

- "mood_weather": { title, prompt }
  今日心情天氣：每人從10種天氣（大晴天/部分晴/陰天/毛毛雨/下雨天/大雷雨/雨後彩虹/強風/下雪/起霧）選一種並說原因（≥5字），揭曉後顯示天氣徽章統計＋個人卡片，適合每日開場/情緒確認/工作坊暖身

- "movie_genre": { title, prompt }
  我是哪種電影：每人從9種電影類型（動作冒險/浪漫喜劇/懸疑驚悚/科幻奇幻/紀錄片/動畫/恐怖驚悚/家庭溫情/文藝獨立）選一種並說原因（≥5字），揭曉後顯示類型徽章統計＋個人卡片，適合破冰/自我介紹/創意工作坊

- "food_mood": { title, prompt }
  今天我是哪道料理：每人從10種料理（熱湯麵/披薩/沙拉/蛋糕/咖啡/便當/冰淇淋/火鍋/麵包/麻辣）選一種並說原因（≥5字），揭曉後顯示料理徽章統計＋個人卡片，適合每日開場/輕鬆破冰/食物主題活動

- "dream_job": { title, prompt }
  童年夢想職業：每人從12種職業（太空人/藝術家/醫生/運動員/廚師/老師/科學家/消防員/飛行員/音樂家/偵探/探險家）選一個並選年齡段（幼稚園/小學/國中/高中）及故事（≥5字），揭曉後顯示職業徽章統計＋夢想故事牆，適合同學會/破冰/跨世代交流

- "travel_style": { title, prompt }
  我的旅行風格：每人從8種旅行風格（背包客/享樂派/冒險家/文化控/美食獵人/放空型/拍照狂/在地控）選一種並分享夢想旅行（≥5字），揭曉後顯示風格徽章統計＋旅行夢想卡片牆，適合旅遊主題活動/員工旅遊/破冰

- "season_person": { title, prompt }
  我是哪個季節的人：每人從4個季節（春/夏/秋/冬）選一個代表自己性格的季節並說原因（≥5字），揭曉後顯示季節徽章統計＋個人卡片，適合自我介紹/破冰/性格探索

- "color_personality": { title, prompt }
  我是哪種顏色：每人從8種顏色（紅/橙/黃/綠/藍/紫/粉紅/白）選一個代表今日狀態的顏色並說原因（≥5字），揭曉後顯示顏色徽章統計＋個人卡片，適合日常暖場/情緒探索/團隊氛圍感知

- "hero_type": { title, prompt }
  我的英雄職業：每人從8種RPG職業（戰士/法師/治療師/遊俠/盜賊/聖騎士/吟遊詩人/德魯伊）選一種並說原因（≥5字），揭曉後顯示職業徽章統計＋個人卡片，適合遊戲主題活動/角色扮演破冰/企業內訓能力探索

- "pet_personality": { title, prompt }
  我是哪種寵物：每人從10種寵物（狗/貓/兔子/倉鼠/小鳥/魚/烏龜/鸚鵡/刺蝟/企鵝）選一種代表自己性格的寵物並說原因（≥5字），揭曉後顯示寵物徽章統計＋個人卡片，適合輕鬆破冰/性格探索/親子活動

- "music_genre": { title, prompt }
  我今天的音樂風格：每人從9種音樂風格（流行/搖滾/爵士/古典/嘻哈/R&B/電子/民謠/Lo-Fi）選一種並說今日狀態感受（≥5字），揭曉後顯示音樂排行統計＋個人卡片，適合日常暖場/創意工作坊/音樂主題活動

- "elemental_type": { title, prompt }
  我是哪種元素：每人從8種元素（火焰/流水/大地/風/雷電/冰雪/光明/暗影）選一種並說原因（≥5字），揭曉後顯示元素徽章統計＋個人卡片，適合奇幻/遊戲主題活動/性格探索/角色扮演破冰

- "coffee_order": { title, prompt }
  我今天的飲料訂單：每人從9種飲品（美式/拿鐵/卡布奇諾/濃縮/抹茶/珍奶/果汁/白開水/熱可可）選一種並說今日狀態（≥5字），揭曉後顯示飲料排行統計＋個人卡片，適合辦公室暖場/下午茶活動/輕鬆日常破冰

- "plant_type": { title, prompt }
  我是哪種植物：每人從10種植物（向日葵/仙人掌/竹子/蘭花/蕨類/蓮花/爬藤/橡樹/苔蘚/櫻花）選一種並說原因（≥5字），揭曉後顯示植物徽章統計＋個人卡片，適合生態主題/心靈探索/自我認識工作坊

- "city_type": { title, prompt }
  我是哪種城市：每人從10座城市（東京/巴黎/紐約/峇里島/倫敦/新加坡/巴塞隆納/京都/冰島/雪梨）選一種並說原因（≥5字），揭曉後顯示城市徽章統計＋個人卡片，適合旅遊主題/國際企業/多元文化破冰

- "gem_stone": { title, prompt }
  我是哪種寶石：每人從9種寶石（鑽石/紅寶石/祖母綠/藍寶石/紫水晶/黃玉/蛋白石/珍珠/黑曜石）選一種並說原因（≥5字），揭曉後顯示寶石徽章統計＋個人卡片，適合個性探索/深度認識/工作坊開場

- "myth_animal": { title, prompt }
  我是哪種神話神獸：每人從9種神獸（龍/鳳凰/獨角獸/麒麟/獅鷲/美人魚/九尾狐/飛馬/雷鳥）選一種並說原因（≥5字），揭曉後顯示神獸徽章統計＋個人卡片，適合奇幻主題/創意活動/神話文化探索

- "tea_type": { title, prompt }
  我是哪種茶：每人從9種茶（綠茶/紅茶/烏龍茶/抹茶/花草茶/普洱茶/白茶/茉莉花茶/珍珠奶茶）選一種並說原因（≥5字），揭曉後顯示茶類統計＋個人卡片，適合茶道主題/下午茶活動/日系文化探索

- "planet_type": { title, prompt }
  我是哪顆星球：每人從9顆星球（水星/金星/地球/火星/木星/土星/天王星/海王星/冥王星）選一顆並說原因（≥5字），揭曉後顯示星球統計＋個人卡片，適合宇宙主題/科學活動/天文愛好者破冰

- "vehicle_type": { title, prompt }
  我是哪種交通工具：每人從9種工具（腳踏車/摩托車/SUV/跑車/火車/飛機/帆船/熱氣球/潛水艇）選一種並說原因（≥5字），揭曉後顯示工具統計＋個人卡片，適合旅遊主題/移動文化/行動力探索

- "weather_type": { title, prompt }
  我是哪種天氣：每人從9種天氣（晴天/陰天/雨天/暴風雨/下雪/霧天/彩虹/大風天/極光）選一種並說原因（≥5字），揭曉後顯示天氣統計＋個人卡片，適合氣象主題/情緒探索/個性多元活動

- "sport_vibes": { title, prompt }
  我今天的運動感：每人從9種運動（跑步/瑜伽/健身房/游泳/登山健行/騎車/舞蹈/球類運動/武術格鬥）選一種並說今日感受（≥5字），揭曉後顯示運動統計＋個人卡片，適合健康主題活動/企業員工健康日/運動型破冰

- "movie_role": { title, prompt }
  我在故事中的角色：每人從8種故事原型（主角/導師/夥伴/反派/搗蛋鬼/智者/守護者/創造者）選一種並說原因（≥5字），揭曉後顯示角色統計＋個人卡片，適合電影節/團隊動態探索/戲劇工作坊/創意活動

- "book_genre": { title, prompt }
  我是哪種書：每人從9種書籍類型（奇幻小說/科幻小說/言情/推理/勵志/歷史/驚悚/漫畫圖像/詩集）選一種並說原因（≥5字），揭曉後顯示書籍類型統計＋個人卡片，適合讀書會/文化活動/閱讀個性探索/知識型破冰

- "flower_type": { title, prompt }
  我是哪種花：每人從9種花朵（玫瑰/百合/鬱金香/雛菊/薰衣草/牡丹/繡球花/鳶尾花/菊花）選一種並說原因（≥5字），揭曉後顯示花朵統計＋個人卡片，適合婚禮/生日/女性聚會/自然主題活動/個性花語探索

- "coffee_type": { title, prompt }
  我是哪種咖啡：每人從9種咖啡（濃縮/美式/拿鐵/卡布奇諾/瑪奇朵/冷萃/手沖/摩卡/馥列白）選一種並說原因（≥5字），揭曉後顯示咖啡統計＋個人卡片，適合咖啡文化活動/企業早午餐破冰/咖啡館聚會/個性探索

- "tree_type": { title, prompt }
  我是哪種樹：每人從9種樹木（橡樹/竹子/櫻花樹/松樹/柳樹/榕樹/楓樹/白樺樹/仙人掌）選一種並說原因（≥5字），揭曉後顯示樹木統計＋個人卡片，適合自然主題活動/戶外教育/生態探索/個性象徵活動

- "ocean_creature": { title, prompt }
  我是哪種海洋生物：每人從9種海洋生物（海豚/鯊魚/鯨魚/章魚/海馬/水母/海龜/海星/魟魚）選一種並說原因（≥5字），揭曉後顯示海洋生物統計＋個人卡片，適合海洋主題/戶外活動/環境教育/自然個性探索

- "candy_type": { title, prompt }
  我是哪種糖果：每人從9種糖果（巧克力/軟糖/棒棒糖/硬糖/棉花糖/焦糖/酸糖/薄荷糖/雲朵棉花糖）選一種並說原因（≥5字），揭曉後顯示糖果統計＋個人卡片，適合兒童活動/生日派對/甜蜜氛圍/輕鬆有趣破冰

- "spice_type": { title, prompt }
  我是哪種香料：每人從9種香料（辣椒/薑/肉桂/大蒜/薑黃/香草/黑胡椒/荳蔻/羅勒）選一種並說原因（≥5字），揭曉後顯示香料統計＋個人卡片，適合美食主題活動/文化交流/料理工作坊/個性風味探索

- "board_game": { title, prompt }
  我是哪種桌遊：每人從9種桌遊（西洋棋/撲克牌/麻將/大富翁/烏諾/益智問答/角色扮演/戰略遊戲/派對遊戲）選一種並說原因（≥5字），揭曉後顯示桌遊統計＋個人卡片，適合遊戲主題/桌遊咖廳/團隊個性分析/輕鬆聚會

- "landscape_type": { title, prompt }
  我是哪種地景：每人從9種地景（山岳/海洋/森林/沙漠/草原/島嶼/峽谷/冰川/濕地）選一種並說原因（≥5字），揭曉後顯示地景統計＋個人卡片，適合自然主題活動/環境教育/戶外探索/地理文化交流

- "art_style": { title, prompt }
  我是哪種藝術風格：每人從9種藝術風格（印象派/抽象藝術/寫實主義/極簡主義/超現實主義/普普藝術/街頭藝術/水彩/攝影）選一種並說原因（≥5字），揭曉後顯示風格統計＋個人卡片，適合藝文活動/創意工作坊/設計團隊/文化交流

- "insect_type": { title, prompt }
  我是哪種昆蟲：每人從9種昆蟲（蝴蝶/蜜蜂/蜻蜓/瓢蟲/螢火蟲/甲蟲/蚱蜢/螳螂/螞蟻）選一種並說原因（≥5字），揭曉後顯示昆蟲統計＋個人卡片，適合自然主題/環境教育/兒童活動/生態探索

- "gemstone_type": { title, prompt }
  我是哪種寶石：每人從9種寶石（鑽石/紅寶石/祖母綠/藍寶石/紫水晶/黃玉/蛋白石/珍珠/翡翠）選一種並說原因（≥5字），揭曉後顯示寶石統計＋個人卡片，適合珠寶主題/高端活動/婚禮/個性閃耀探索

- "mythical_creature": { title, prompt }
  我是哪種神話生物：每人從9種神話生物（龍/鳳凰/獨角獸/獅鷲/美人魚/天馬/海怪/狼人/斯芬克斯）選一種並說原因（≥5字），揭曉後顯示神話統計＋個人卡片，適合奇幻主題/創意活動/故事工作坊/個性探索

- "dance_style": { title, prompt }
  我是哪種舞蹈：每人從9種舞蹈（芭蕾/嘻哈/華爾滋/探戈/佛朗明哥/霹靂舞/現代舞/民俗舞/莎莎）選一種並說原因（≥5字），揭曉後顯示舞蹈統計＋個人卡片，適合藝術活動/表演藝術/多元文化交流/活力破冰

- "architecture_style": { title, prompt }
  我是哪種建築風格：每人從9種建築風格（現代主義/巴洛克/極簡主義/野獸派/裝飾藝術/哥德式/日北歐/工業風/地中海）選一種並說原因（≥5字），揭曉後顯示風格統計＋個人卡片，適合設計活動/空間活化/創意工作坊/建築文化交流

- "cheese_type": { title, prompt }
  我是哪種起司：每人從9種起司（切達/布利/高達/帕瑪森/莫扎瑞拉/卡門貝爾/菲達/瑞可塔/瑞士）選一種並說原因（≥5字），揭曉後顯示起司統計＋個人卡片，適合美食主題/歐洲文化/餐廳活動/輕鬆美食個性探索

- "mushroom_type": { title, prompt }
  我是哪種菇類：每人從9種菇類（香菇/松露/雞油菌/牛肝菌/平菇/洋菇/波特菇/金針菇/羊肚菌）選一種並說原因（≥5字），揭曉後顯示菇類統計＋個人卡片，適合美食主題/自然料理/文化交流/輕鬆個性破冰

- "pasta_type": { title, prompt }
  我是哪種義大利麵：每人從9種義大利麵（義大利麵/斜管麵/螺旋麵/千層麵/義大利餃/寬麵/肋管麵/麵疙瘩/蛋麵）選一種並說原因（≥5字），揭曉後顯示義麵統計＋個人卡片，適合義式主題/美食文化/輕鬆聚會/旅遊分享

- "sushi_type": { title, prompt }
  我是哪種壽司：每人從9種壽司（鮭魚握壽司/鮪魚握壽司/加州卷/龍卷/手卷/生魚片/軍艦卷/散壽司/稻荷壽司）選一種並說原因（≥5字），揭曉後顯示壽司統計＋個人卡片，適合日式主題/美食聚會/旅遊分享/個性破冰

- "material_type": { title, prompt }
  我是哪種材質：每人從9種材質（木材/金屬/玻璃/陶瓷/布料/石材/混凝土/皮革/竹材）選一種並說原因（≥5字），揭曉後顯示材質統計＋個人卡片，適合設計/建築/創意工作坊/空間規劃/個性探索

- "fruit_type": { title, prompt }
  我是哪種水果：每人從9種水果（蘋果/芒果/草莓/西瓜/葡萄/檸檬/鳳梨/水蜜桃/藍莓）選一種並說原因（≥5字），揭曉後顯示水果統計＋個人卡片，適合夏日活動/美食主題/輕鬆聚會/個性破冰

- "chocolate_type": { title, prompt }
  我是哪種巧克力：每人從9種巧克力（黑巧克力/牛奶巧克力/白巧克力/抹茶/焦糖/覆盆子/柑橘/榛果/松露）選一種並說原因（≥5字），揭曉後顯示巧克力統計＋個人卡片，適合甜點主題/情人節/聚會破冰/個性探索

- "bird_type": { title, prompt }
  我是哪種鳥類：每人從9種鳥類（老鷹/貓頭鷹/鸚鵡/企鵝/紅鶴/孔雀/蜂鳥/烏鴉/天鵝）選一種並說原因（≥5字），揭曉後顯示鳥類統計＋個人卡片，適合自然主題/企業培訓/個性探索/破冰活動

- "fish_type": { title, prompt }
  我是哪種魚：每人從9種魚（鮭魚/鮪魚/小丑魚/鯊魚/金魚/錦鯉/神仙魚/河豚/旗魚）選一種並說原因（≥5字），揭曉後顯示魚類統計＋個人卡片，適合海洋主題/水族館活動/自然探索/個性分析

- "ice_cream_type": { title, prompt }
  我是哪種冰淇淋：每人從9種冰淇淋（香草/巧克力/草莓/抹茶/薄荷巧克力/奧利奧/芒果/藍莓/檸檬雪酪）選一種並說原因（≥5字），揭曉後顯示冰淇淋統計＋個人卡片，適合夏日活動/甜食主題/聚會破冰/輕鬆探索

- "pizza_type": { title, prompt }
  我是哪種披薩：每人從9種披薩（瑪格麗特/辣香腸/BBQ雞肉/蔬食/夏威夷/松露/海鮮/四種起司/卡爾佐內）選一種並說原因（≥5字），揭曉後顯示披薩統計＋個人卡片，適合義式主題/美食破冰/聚餐活動/個性探索
