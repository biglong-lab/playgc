...
import { db } from "../db";
import { bookings, activities, posTransactions, platformCoupons, couponTemplates, fields, posProducts, posModifierOptions, posTransactionItems, refunds } from "@shared/schema";
